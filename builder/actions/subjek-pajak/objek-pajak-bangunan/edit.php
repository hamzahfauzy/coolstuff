...
$clause = "DAT_OP_BANGUNAN.KD_PROPINSI + '.' + DAT_OP_BANGUNAN.KD_DATI2 + '.' + DAT_OP_BANGUNAN.KD_KECAMATAN + '.' + DAT_OP_BANGUNAN.KD_KELURAHAN + '.' + DAT_OP_BANGUNAN.KD_BLOK + '-' + NO_URUT + '.' + KD_JNS_OP";
...
$data = $qb
            ...
            ->andJoin('DAT_OP_BANGUNAN.KD_KELURAHAN','kelurahan.KD_KELURAHAN')->where($clause,$_GET['NOP'])->where('NO_BNG*1',$_GET['NO_BNG'])->orderBy('NO_BNG*1','desc')->first();

$fasilitas = [];
$INDIVIDU = [];

function CALL_INDIVIDU(){

    global $INDIVIDU;

    $qb = new QueryBuilder();
    
    $StrQ1 = "Select * From DAT_NILAI_INDIVIDU WHERE KD_PROPINSI + '.' + KD_DATI2 + '.' + KD_KECAMATAN + '.' + KD_KELURAHAN + '.' + KD_BLOK + '-' + NO_URUT + '.' + KD_JNS_OP =  '" . trim($_GET['NOP']) . "' AND NO_BNG*1='" . $_GET['NO_BNG'] . "' ORDER BY NO_BNG*1 DESC";
    
    $INDIVIDU = $qb->rawQuery($StrQ1)->first();
...
//     $qb = new QueryBuilder();
    ...
    $StrQ2 = "Select * From DAT_FASILITAS_BANGUNAN WHERE KD_PROPINSI + '.' + KD_DATI2 + '.' + KD_KECAMATAN + '.' + KD_KELURAHAN + '.' + KD_BLOK + '-' + NO_URUT + '.' + KD_JNS_OP =  '" . trim($_GET['NOP']) . "' AND NO_BNG*1='" . $_GET['NO_BNG'] . "' ORDER BY NO_BNG*1 DESC";
    
    $data2 = $qb->rawQuery($StrQ2)->get();
    
    foreach ($data2 as $key => $value) {
        if( $value['KD_FASILITAS'] == "35" ){
            $fasilitas['cbo_pagar'] = "01";
            $fasilitas["tPagar"] = $value['JML_SATUAN'];
        }elseif( $value['KD_FASILITAS'] == "36" ){
            $fasilitas['cbo_pagar'] = "02";
            $fasilitas["tPagar"] = $value['JML_SATUAN'];
        }
    
        if( $value['KD_FASILITAS'] == "14" ) $fasilitas['tHal1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "15" ) $fasilitas['tHal2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "16" ) $fasilitas['tHal3'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "17" ) $fasilitas['tHal4'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "40" ) $fasilitas['tGenset'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "41" ) $fasilitas['tPABX'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "42" ) $fasilitas['tSumur'] = $value['JML_SATUAN'];
    
        if( $value['KD_FASILITAS'] == "12" ){
            $fasilitas['cbo_kolam'] = "01";
            $fasilitas['tKolam'] = $value['JML_SATUAN'];
        }elseif( $value['KD_FASILITAS'] == "13" ){
            $fasilitas['cbo_kolam'] = "02";
            $fasilitas['tKolam'] = $value['JML_SATUAN'];
        }
    
        if( $value['KD_FASILITAS'] == "37" ) $fasilitas["cbo_hydrant"] = "01";
        if( $value['KD_FASILITAS'] == "38" ) $fasilitas["cbo_springkler"] = "01";
        if( $value['KD_FASILITAS'] == "39" ) $fasilitas["cbo_fa"] = "01";
        
        if( $value['KD_FASILITAS'] == "18" ) $fasilitas['tLap_Beton1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "19" ) $fasilitas['tLap_Aspal1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "20" ) $fasilitas['tLap_Tanah1'] = $value['JML_SATUAN'];

        if( $value['KD_FASILITAS'] == "21" ) $fasilitas['tLap_Beton2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "22" ) $fasilitas['tLap_Aspal2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "23" ) $fasilitas['tLap_Tanah2'] = $value['JML_SATUAN'];
        
        if( $value['KD_FASILITAS'] == "24" ) $fasilitas['tLap_Beton1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "25" ) $fasilitas['tLap_Aspal1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "26" ) $fasilitas['tLap_Tanah1'] = $value['JML_SATUAN'];

        if( $value['KD_FASILITAS'] == "27" ) $fasilitas['tLap_Beton2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "28" ) $fasilitas['tLap_Aspal2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "29" ) $fasilitas['tLap_Tanah2'] = $value['JML_SATUAN'];
        
        if( $value['KD_FASILITAS'] == "30" ) $fasilitas['tLift1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "31" ) $fasilitas['tLift2'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "32" ) $fasilitas['tLift3'] = $value['JML_SATUAN'];
        
        if( $value['KD_FASILITAS'] == "33" ) $fasilitas['tTangga1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "34" ) $fasilitas['tTangga2'] = $value['JML_SATUAN'];
        
        if( $value['KD_FASILITAS'] == "01" ) $fasilitas['tAC1'] = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "02" ) $fasilitas['tAC2'] = $value['JML_SATUAN'];
        
        // if( $value['KD_FASILITAS'] == "03" ) JPB29.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "04" ) JPB7c.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "05" ) JPB7b.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "06" ) JPB4.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "07" ) JPB5a.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "08" ) JPB5b.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "09" ) JPB13c.Text = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "10" ) JPB13a.Text = $value['JML_SATUAN'];
        
        if( $value['KD_FASILITAS'] == "11" ) $fasilitas['cbo_ac'] = "01";
        
        // if( $value['KD_FASILITAS'] == "43" ) JPB7d.Text = $value['JML_SATUAN'];
        if( $value['KD_FASILITAS'] == "44" ) $fasilitas['tListrik'] = $value['JML_SATUAN'];
        // if( $value['KD_FASILITAS'] == "45" ) JPB13d.Text = $value['JML_SATUAN'];
    }
    ...
    // if( $xJPB == "02" ){
        ...
        //     // if( rPajak.RecordCount > 0 ){ rPajak.MoveFirst
...
{   
    ...
    if(isset($_POST['update'])){
        ...
        function UP_FASILITAS1(){
            global $xxKec,$xxKel,$xxBlok,$xxUrut,$xxJenis;

            extract($_POST);

            $dSQL1 = "Delete from DAT_FASILITAS_BANGUNAN WHERE (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $NO_BNG . "')";
            
            CALL_FASILITAS();

        }

        function UP_TAMBAHAN1(){
            ...
            if( ($xJPB == 1 || $xJPB == 10 || $xJPB == 11) || (($xJPB == 2 || $xJPB == 4 || $xJPB == 5 || $xJPB == 7 || $xJPB == 9) && $JML_LANTAI_BNG <= 4) ){

                // DATA TIDAK BENAR

            }elseif( $xJPB == "02" ){ 

                $eSQL3 = "DELETE FROM DAT_JPB2 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";

                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "03" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB3 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "04" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB4 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "05" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB5 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "06" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB6 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "07" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB7 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "08" ){
                $eSQL3 = "DELETE FROM DAT_JPB8 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();
                
            }elseif( $xJPB == "09" ){
                $eSQL3 = "DELETE FROM DAT_JPB9 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "12" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB12 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "13" ){
                $eSQL3 = "DELETE FROM DAT_JPB13  where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "14" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB14 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "15" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB15 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "16" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB16 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();

            }elseif( $xJPB == "17" ){ 
                $eSQL3 = "DELETE FROM DAT_JPB17 where (KD_KECAMATAN='" . $xxKec . "' AND KD_KELURAHAN='" . $xxKel . "' AND KD_BLOK='" . $xxBlok . "' AND NO_URUT='" . $xxUrut . "' AND KD_JNS_OP='" . $xxJenis . "' AND NO_BNG*1='" . $JML_LANTAI_BNG . "')";
                $qb->rawQuery($eSQL3)->exec();
