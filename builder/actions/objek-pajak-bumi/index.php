...
$datas = $qb
            ...
            ->leftJoin('QOBJEKPAJAK as qop','DAT_OP_BUMI.SUBJEK_PAJAK_ID','qop.SUBJEK_PAJAK_ID')
...
$limits = $qb4->select("DAT_OP_BUMI","count(*) as count")->leftJoin('QOBJEKPAJAK as qop','DAT_OP_BUMI.SUBJEK_PAJAK_ID','qop.SUBJEK_PAJAK_ID');
