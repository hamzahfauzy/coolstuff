...
<div class="content lg:max-w-screen-lg lg:mx-auto py-8">
    <h2 class="text-3xl">Penetapan SPPT Massal</h2>
    <div class="my-6">
        <?php if($msg): ?>
...
<script>
    function kecamatanChange(el){
        fetch("index.php?page=builder/penetapan-sppt-massal/index&filter-kecamatan="+el.value).then(response => response.json()).then(data => {
