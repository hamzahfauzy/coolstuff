...
<div class="content lg:max-w-screen-lg lg:mx-auto py-8">
    ...
    <div class="my-6">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="index.php?page=builder/laporan/dhkp/index" class="p-2 bg-yellow-500 text-white rounded block text-center">Kembali</a>
        </div>
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                <a href="index.php?page=builder/laporan/sspd/cetak&NOP=<?=$data['NOPQ']?>&tahun_pajak=<?=$_GET['tahun_pajak']?>&tanggal_terbit=<?=$_GET['tanggal_terbit']?>&tanggal_cetak=<?=$_GET['tanggal_cetak']?>&nip_pencetak=<?=$_GET['nip_pencetak']?>" target="_blank" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
