...
<div class="content lg:max-w-screen-lg lg:mx-auto py-8">
    <h2 class="text-4xl">Edit Pejabat : <?=$data['NAMA']?></h2>
    <div class="bg-white shadow-md rounded my-6 p-8">
        <form id="login-form" action="index.php?page=<?=$_GET['page']?>&pejabat=<?=$_GET['pejabat']?>" method="post" enctype="multipart/form-data">
            <?php 
            ...
            <div class="form-group">
                ...
                <a href="index.php?page=builder/pejabat/index" class="w-full p-2 bg-yellow-500 text-white rounded block text-center mt-2">Kembali</a>
            </div>
        </form>
    </div>
</div>
