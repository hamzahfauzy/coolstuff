...
<div class="content lg:max-w-screen-lg lg:mx-auto py-8">
    <h2 class="text-3xl">Cetak Klasifikasi dan Besaran NJOP Bumi</h2>
    <div class="bg-white shadow-md rounded my-6 p-8">
        <form action="index.php" onsubmit="doSubmit(this); return false;">
            <input type="hidden" name="page" value="builder/laporan/klasifikasi-dan-besaran-njop-bumi/results">
...
<script>
    ...
    function kecamatanChange(el){
        ...
        {
            fetch("index.php?page=builder/laporan/klasifikasi-dan-besaran-njop-bumi/index&get-kelurahan=true&KD_KECAMATAN="+el.value).then(response => response.json()).then(data => {
    ...
    function doSubmit(form){
        ...
        .then(res => {
            ...
            {
                location.href='index.php?page=builder/laporan/klasifikasi-dan-besaran-njop-bumi/cetak-all&tahun_pajak='+document.querySelector("select[name=tahun_pajak]").value+'&KD_KECAMATAN='+document.querySelector("select[name=KD_KECAMATAN]").value+'&KD_KELURAHAN='+document.querySelector("select[name=KD_KELURAHAN]").value
