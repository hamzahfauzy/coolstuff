        ...
        <div class="flex justify-between">
            ...
            <div>
                <form action="" method="get">
                    ...
                    <div class="form-group inline-block">
                        <input type="text" class="p-2 w-full border rounded" placeholder="Cari.." name="roles" value="<?=isset($_GET['roles']) && $_GET['roles'] ? $_GET['roles'] : '' ?>">
                    </div>
            ...
            <table class="min-w-max w-full table-auto">
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-left whitespace-nowrap">
                            <div class="flex items-center">
                                <span class="font-medium"><?=$data['KD_WEWENANG']?></span>
                            </div>
                        </td>
                        <td class="py-3 px-6 text-left whitespace-nowrap">
                            <div class="flex items-center">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                                ...
                                <a href="index.php?action=builder/roles/delete&roles=<?=$data['KD_WEWENANG']?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110" onclick="if(confirm('Apakah anda yakin menghapus data ini')){return true}else{return false}">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
