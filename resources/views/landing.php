...
<head>
	...
	<style>
		.how-to-number{margin: 0;padding: 0;width: 50px;height: 50px;text-align: center;border:1px solid #fff400;border-radius: 50%;background: #fff973;}
	</style>
</head>
									...
									<g fill="none" fill-rule="evenodd">
										...
										<g class="anime-element fadeleft-animation">
											<g transform="translate(103 75)">
												<image mask="url(#hero-illustration-l)" width="500" xlink:href="dist/images/earth.png"/>
											</g>
										</g>
										<g class="anime-element fadeleft-animation">
											<g transform="translate(56 157)">
												<image mask="url(#hero-illustration-l)" width="500" xlink:href="dist/images/bulding.png"/>
											</g>
										</g>
									</g>
								</svg>
