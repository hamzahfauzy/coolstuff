    ...
    <?php elseif($submit && $jenis_op == 'bumi'): ?>
        ...
        <form id="login-form" action="" method="post" enctype="multipart/form-data" style="margin-left:auto;margin-right:auto;max-width:1000px;">
            ...
            <div class="bg-white shadow-md rounded my-6 p-8">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="form-group mb-2">
                        <label>No HP</label>
                        <input type="text" class="p-2 mt-2 w-full border rounded" value="<?=isset($old) && $old["NO_HP"] ? $old["NO_HP"] : ''?>" name="NO_HP">
                    </div>

                    <div class="form-group mb-2">
                        <label>Email</label>
                        <input type="text" class="p-2 mt-2 w-full border rounded" value="<?=isset($old) && $old["EMAIL"] ? $old["EMAIL"] : ''?>" name="EMAIL">
                    </div>
            ...
            <div class="bg-white shadow-md rounded my-6 p-8">
                ...
                <div class="form-group mb-2">
                    <label>KTP</label>
                    <input type="file" name="KTP" id="" class="p-2 mt-2 w-full border rounded">
                </div>
                
                <div class="form-group mb-2">
                    <label>Foto Objek</label>
                    <input type="file" name="FOTO_OBJEK" id="" class="p-2 mt-2 w-full border rounded">
                </div>
                
                <div class="form-group mb-2">
                    <label>Surat Tanah</label>
                    <input type="file" name="SURAT_TANAH" id="" class="p-2 mt-2 w-full border rounded">
                </div>
            ...
            <div class="bg-white shadow-md rounded my-6 p-8">
                ...
                <div class="form-group">
                    <button class="w-full p-2 bg-indigo-800 text-white rounded" name="proses_bumi">Submit</button>
                </div>
        ...
        <script>
            ...
            function kecamatanChange(el){
                fetch("index.php?page=api/objek-pajak-bumi/index&filter-kecamatan="+el.value).then(response => response.json()).then(data => {
            ...
            function kelurahanChange(el){
                ...
                fetch("index.php?page=api/objek-pajak-bumi/index&filter-kelurahan="+el.value+"&filter-kecamatan="+kecamatan.value).then(response => response.json()).then(data => {
                ...
                fetch("index.php?page=api/objek-pajak-bumi/index&get-jalan=true&filter-kelurahan="+el.value+"&filter-kecamatan="+kecamatan.value).then(response => response.json()).then(data => {
            ...
            function blokChange(el){
                ...
                fetch("index.php?page=api/objek-pajak-bumi/index&filter-blok="+el.value+"&filter-kelurahan="+kelurahan.value+"&filter-kecamatan="+kecamatan.value).then(response => response.json()).then(data => {
    ...
    <?php elseif($submit && $jenis_op == 'bangunan'): ?>
        <form id="bangunan" action="" method="post" enctype="multipart/form-data" style="margin-left:auto;margin-right:auto;max-width:1000px;">
            ...
            <div class="bg-white shadow-md rounded my-6 p-8">
                ...
                <div class="form-group">
                    <button class="w-full p-2 bg-indigo-800 text-white rounded" name="proses_bangunan">Submit</button>
                </div>
...
<script>
    $(document).ready(e => {
        ...
        nopq.inputmask({mask:"12.12.999.999.999-9{1,4}.9"})
        ...
        status.change(function(e){
            if (e.target.value != '-') {
                ...
                if(e.target.value == "Terdaftar" && jenisOp.val() == 'bumi') {
        ...
        if(jenis_op == 'bangunan') {
            ...
            var exists = <?= json_encode($exists) ?>;
            if(dt.hasOwnProperty('NOP')){
                if(exists.hasOwnProperty('NO_BNG')) {
